...
Gebruik drie keer de \` boven de code, en dan weer drie keer \` eronder.
Of juist \~\~\~ voor en na het stukje code! Bij de Callout-voorbeelden werkte \`\`\` niet, maar \~\~\~ wel. Het luistert soms nauw..
...
Je kan ook highligthten volgens programmacode. 
