...
<Callout type="info">
Sterke aanrader voor de leesbaarheid tijdens editten is het aanzetten van de Markdown syntax voor .mdx files.
Dit kan je doen door rechts-onder op de button naast UTF-8 te klikken. als dit niet is ingesteld op "Markdown" staat hier "Plain Text"
[<img src="/assets/meta/23-mdx-syntaxt.jpg" width="350"/>]()
</Callout>
